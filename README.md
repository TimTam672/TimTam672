...
* **Machine Learning:** Scikit-Learn, XGBoost, LightGBM (LGBM), CatBoost, HyperOPT
* **Deep Learning & GenAI:** PyTorch, Generative AI
* **Computer Vision & NLP:** OpenCV, Natural Language Processing, Computer Vision
* **Data Science Essentials:** NumPy, SciPy, Pandas, Matplotlib, Seaborn

### 📊 Data Pipelines & Analytics
* **Dashboards & BI:** Power BI, Streamlit
* **Data Engineering:** Web Scraping, Power Query
* **Automation & Tools:** Excel VBA, Microsoft Access
